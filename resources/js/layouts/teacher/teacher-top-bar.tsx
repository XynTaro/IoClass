        ...
        <header className="sticky top-0 z-30 flex h-[64px] shrink-0 items-center gap-3 border-b border-border/60 bg-background/95 px-4 backdrop-blur supports-backdrop-filter:bg-background/80 md:gap-4 md:px-6">
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
                ...
                >
                    ...
                    <TeacherSidebarNav isCollapsed={false} />
                </SheetContent>
            </Sheet>
            ...
            <div className="ml-auto flex shrink-0 items-center gap-1 md:gap-2">
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            ...
                            <div className="hidden min-w-0 flex-col items-start text-left md:flex">
                                ...
                                <span className="inline-flex items-center rounded-full bg-blue-50 px-1.5 py-0.5 text-[10px] font-semibold text-blue-700 dark:bg-blue-950/40 dark:text-blue-400">
                                    Teacher
                                </span>
                            </div>
                        </Button>
                    ...
                    <DropdownMenuContent className="w-56" align="end">
                        <UserMenuContent user={auth.user} profileUrl={teacher.profile.show.url()} />
                    </DropdownMenuContent>
                </DropdownMenu>
            </div>
        </header>
